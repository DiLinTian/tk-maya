...
# add custom env
env_path = r'P:\cfa_tools\cfa_plug-ins\cfa_tools'
...
def autoLoadPlugin():
    # AbcExport.mll
    # AbcImport.mll
    print "auto load plugin..."
    load_plugin = ["AbcExport.mll","AbcImport.mll"]
    for plugin in load_plugin:
